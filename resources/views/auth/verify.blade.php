                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">
                            ¡Gracias por confirmar tu cuenta!</h1>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p style="margin: 0;">Ahora ya puedes usar tu email para poner iniciar sección en la plataforma,
                            entra
                            <a href="https://sendgrid.com">aquí</a>.</p>
                    </td>
                </tr>
                <!-- end copy -->
