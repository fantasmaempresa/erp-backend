        ...
        $shapes = [
            [
                ...
                'form' => [
                    ...
                    ['name' => 'alienated_property_street', 'type' => 'text', 'label' => 'Calle del inmueble enagenado'],
                    ['name' => 'alienated_property_outdoor_number', 'type' => 'text', 'label' => 'NoExt del inmueble enagenado'],
                    ['name' => 'alienated_property_interior_number', 'type' => 'text', 'label' => 'NoInt del inmueble enagenado '],
                    ['name' => 'alienated_property_colony', 'type' => 'text', 'label' => 'Colonia del inmueble enagenado'],
                    ['name' => 'alienated_property_locality', 'type' => 'text', 'label' => 'Localidad del inmueble enagenado'],
                    ['name' => 'alienated_property_municipality', 'type' => 'text', 'label' => 'Municipio del inmueble enagenado'],
                    ['name' => 'alienated_property_entity', 'type' => 'text', 'label' => 'Entidad del inmueble enagenado'],
                    ['name' => 'alienated_property_zipcode', 'type' => 'number', 'label' => 'Código Postal del inmueble enagenado'],
                    ...
                    ['name' => 'alienating_quote_basis', 'number' => 'text', 'label' => 'Cuota de Fundamento Enajenante'],
                    ['name' => 'acquirer_basis', 'type' => 'text', 'label' => 'Fundameto Adquiriente'],
                    ['name' => 'acquirer_quote_basis', 'type' => 'number', 'label' => 'Cuota de fundamento Adquiriente'],
                    ['name' => 'alienated_property_basis', 'type' => 'text', 'label' => 'Fundamento del inmueble enagenado'],
                    ['name' => 'alienated_property_quote_basis', 'number' => 'text', 'label' => 'Cuota del Fundamento del inmueble enagenado'],
            ...
            [
                ...
                'form' => [
                    ...
                    ['name' => 'alienated_property_home', 'type' => 'text', 'label' => 'Domicilio de la propiedad a enajenar'],
