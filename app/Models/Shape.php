...
class Shape extends Model
{
    ...
    public static function rules(): array
    {
        ...
        return [
            ...
            'template_shape_id' => 'required|int|exists:template_shapes,id',
            'procedure_id' => 'required|int|exists:procedures,id',
            'operation_id' => 'required|int|exists:operations,id',
            'alienating' => 'required|int|exists:grantors,id',
            'acquirer' => 'nullable|int|exists:grantors,id',
