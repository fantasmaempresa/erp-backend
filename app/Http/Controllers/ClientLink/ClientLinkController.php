...
class ClientLinkController extends ApiController
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        if (!empty($request->get('search')) && $request->get('search') !== 'null') {
            $clientLinks = ClientLink::where('client_id', $request->get('client_id'))->search($request->get('search'))->with('user')->orderBy('last_name')->paginate($paginate);
        } else {
            $clientLinks = ClientLink::where('client_id', $request->get('client_id'))->with('user')->orderBy('last_name')->paginate($paginate);
        }
